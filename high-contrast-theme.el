...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "black" :foreground "gold" :bold 1))))
 '(modeline-buffer-id ((t (:inherit mode-line :family "Lucida Grande" :foreground "white"))))
 '(mode-line-inactive ((t (:inherit mode-line :foreground "medium purple"))))
