...
(defun ocp-index-setup ()
  ...
  (with-eval-after-load 'evil
    ...
    (define-key evil-normal-state-map (kbd "C-.") 'ocp-index-jump-to-definition-at-point-maybe-other-window)
    (define-key evil-normal-state-map (kbd "M-.") 'ocp-index-jump-to-sig-at-point-maybe-other-window)))
