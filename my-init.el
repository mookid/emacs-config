...
(progn
  ...
  (let ((face 'font-lock-comment-face))
    ...
    (set-face-background face "ghost white"))
  (let ((face 'font-lock-variable-name-face))
    (set-face-foreground face "magenta4"))
  (let ((face 'font-lock-function-name-face))
    (set-face-foreground face "brown4"))
  (let ((face 'font-lock-constant-face))
    (set-face-foreground face "dark green"))
  (let ((face 'font-lock-string-face))
  ...
  (let ((face 'mode-line))
    ...
    (set-face-attribute face nil :box '(:line-width 1 :color "black")))
  (let ((face 'mode-line-inactive))
    (set-face-background face "honeydew")
    (set-face-foreground face "grey")
