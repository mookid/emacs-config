...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tuareg smooth-scrolling slime rainbow-delimiters rainbow-blocks ocp-indent loccur lispy gnuplot-mode flycheck find-file-in-project expand-region evil-visualstar evil-search-highlight-persist evil-numbers evil-jumper evil-anzu elisp-slime-nav d-mode counsel company clang-format))))
(custom-set-faces
